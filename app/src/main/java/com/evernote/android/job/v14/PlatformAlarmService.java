...
public final class PlatformAlarmService extends android.support.v4.app.c {
   private static final com.evernote.android.job.util.d j = new com.evernote.android.job.util.d("PlatformAlarmService");
   ...
   static void a(Intent var0, Service var1, com.evernote.android.job.util.d var2) {
      if (var0 == null) {
         ...
         JobProxy.a var5 = new JobProxy.a(var1, var2, var3);
         JobRequest var6 = var5.a(true, true);
         if (var6 != null) {
            var5.a(var6, var4);
         }
