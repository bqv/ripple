      ...
      if (var3 != null) {
         ...
         if (var4) {
            ...
            if (TelephonyManager.EXTRA_STATE_IDLE.equals(var3)) {
               i.a(var1, "BRCall.onReceive EXTRA_STATE_IDLE. Broadcasting finish");
               App.b(var1);
            } else if (TelephonyManager.EXTRA_STATE_OFFHOOK.equals(var3)) {
               i.a(var1, "BRCall.onReceive EXTRA_STATE_OFFHOOK. Broadcasting finish");
               App.b(var1);
            } else if (!TelephonyManager.EXTRA_STATE_RINGING.equals(var3)) {
               i.a(var1, "BRCall.onReceive EXTRA_STATE_???????. Broadcasting finish");
               App.b(var1);
            } else {
               StringBuilder var14 = new StringBuilder();
               var14.append("BRCall.onReceive EXTRA_STATE_RINGING lastState    = ");
               var14.append(var6);
               i.a(var1, var14.toString());
               ...
               if (VERSION.SDK_INT >= 28 && !var4) {
                  i.a(var1, "BRCall.onReceive EXTRA_STATE_RINGING Android>=9 without hasCallerID (returning)");
               } else {
                  var3 = var2.getStringExtra("incoming_number");
                  StringBuilder var12 = new StringBuilder();
                  var12.append("BRCall.onReceive EXTRA_STATE_RINGING callerID     = ");
                  var12.append(var3);
                  i.a(var1, var12.toString());
                  String var13 = var3;
                  if (var3 == null) {
                     var13 = "";
                  }
                  ...
                  if (var7 < 2500L) {
                     i.a(var1, "BRCall.onReceive EXTRA_STATE_RINGING dt          < MINDTBETWEENRINGS (return)");
                  } else {
                     if (TelephonyManager.EXTRA_STATE_RINGING.equals(var6)) {
                        i.a(var1, "BRCall.onReceive oldstate=RINGING (ERROR)");
                        if (var7 < 5000L) {
                           i.a(var1, "BRCall.onReceive oldstate=RINGING (ERROR), dt<DTRESETRINGS (return)");
                           return;
                        }

                        i.a(var1, "BRCall.onReceive oldstate=RINGING (ERROR), dt>DTRESETRINGS, proceed as normal");
                     }

                     i.a(var1, String.format(Locale.US, "BRCall.onReceive Sending intent to ServiceMain info=%s text1=%s", var1.getResources().getString(2131492868), var13));
