...
/* renamed from: com.evernote.android.job.a.f */
public final class C0176f {
    /* renamed from: a */
    public static int m636a(int i, String str) {
        if (i >= 0) {
            return i;
        }
    ...
    /* renamed from: a */
    public static long m637a(long j, long j2, long j3, String str) {
        if (j < j2) {
    ...
    /* renamed from: a */
    public static long m638a(long j, String str) {
        if (j >= 0) {
            return j;
        }
        throw new IllegalArgumentException(str);
    ...
    /* renamed from: a */
    public static <T extends CharSequence> T m639a(T t) {
    ...
    /* renamed from: a */
    public static <T> T m641a(T t, Object obj) {
        if (t != null) {
            return t;
        }
    ...
    /* renamed from: b */
    public static long m642b(long j, String str) {
        if (j > 0) {
            return j;
        }
        throw new IllegalArgumentException(str);
